...
export default function ModalReexecutarIncidente({fecharOverlay, idIncidente}){
    ...
    return(
      <>
        ...
        <div 
            ...
            md:text-center
            ">
                Quer reexecutar o incidente 

                <span className="ml-2 pb-2 font-light border-[#D0D0D0] border-b-[2px]">
                    {idIncidente} ?
                </span>
            </h2>
